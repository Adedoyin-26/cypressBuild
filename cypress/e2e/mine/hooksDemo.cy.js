...
describe('hooks demo', function () {
    ...
    beforeEach(function () {
      ...
      cy.get('body').then($body => {
        ...
        if (!loggedIn) {
          ...
          cy.get('#logInModal', { timeout: 10000 }).should('be.visible') // modal id (if present)
    ...
    it('Test Case 1 - Samsung s6', function () {
    ...
    it('Test Case 3 - Nexus', function () {
        cy.get(".hrefch[href='prod.html?idp_=3']", { timeout: 10000 }).should('be.visible').click()
        cy.get('.name', { timeout: 10000 }).should('have.text', 'Nexus 6')
    });

    it('Test Case 4 - Samsung s7', function () {
        cy.get(".hrefch[href='prod.html?idp_=4']", { timeout: 10000 }).should('be.visible').click()
        cy.get('.name', { timeout: 10000 }).should('have.text', 'Samsung galaxy s7')
    });
  })